...
Para além de um showcase profissional, a função inicial (e principal) desse site se assemelha a… (rufem os tambores) ==um blog==.

Aqui, irei expor reflexões, aprendizados, roadmaps, documentações pessoais e diversos outros tipos de conteúdo.

Ele está... um pouquinho vazio atualmente.
